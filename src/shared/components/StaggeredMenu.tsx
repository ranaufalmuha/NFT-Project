          ...
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
            ...
            >
              {items && items.length ? (
                items.map((it, idx) => (
                  <li
                    className="sm-panel-itemWrap relative overflow-hidden leading-none pointer-events-auto"
                    key={it.label + idx}
                  >
                    <a
                      ...
                      data-index={idx + 1}
                    >
                      <span className="sm-panel-itemLabel inline-block origin-[50%_100%] will-change-transform font-sefa">
                        {it.label}
                      </span>
                    </a>
                  </li>
