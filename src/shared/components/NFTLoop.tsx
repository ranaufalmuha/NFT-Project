...
export interface NFTLoopProps {
  ...
  renderItem?: (item: NFTItem, key: React.Key) => React.ReactNode;
  ariaLabel?: string;
  className?: string;
...
export const NFTLoop = React.memo<NFTLoopProps>(
  ({
    logos,
    speed = 120,
    direction = "left",
    ...
    const renderLogoItem = useCallback(
      (item: NFTItem, key: React.Key) => {
        ...
        const content = isNodeItem ? (
          ...
          <img
            className={cx(
              "h-[var(--logoloop-logoHeight)] w-auto block object-cover aspect-square ",
...
NFTLoop.displayName = "NFTLoop";

export default NFTLoop;
