...
const listCharacter = [
  {
    ...
    background: "/images/character/p-1.png",
    color: "text-accent-1",
  ...
  return (
    <section className="mx-auto max-w-7xl flex flex-col w-full gap-6 relative overflow-hidden px-4">
      ...
      <div className="w-full aspect-video relative flex justify-end overflow-hidden">
        <h2
          className={`absolute z-4 top-0 font-sefa uppercase ${listCharacter[activeIndex].color} flex items-center w-full h-full`}
          style={{ fontSize: "15vmin" }}
        >
          {listCharacter[activeIndex].name}
        </h2>
        <div
          className={`bg-linear-to-l ${listCharacter[activeIndex].fromColor} aspect-2/3 h-full`}
        ></div>
        <div className="absolute h-full aspect-4/5 z-5 right-0">
          <Image
        ...
        <div className="absolute left-0 bottom-0 w-1/2 md:w-1/3 overflow-visible z-10">
