...
export default function NFTShowcaseSection() {
  return (
    <section className="flex flex-col py-28 gap-12">
      <h2>
        <ScrollVelocity
      ...
      <Container>
        <div className="max-h-screen overflow-hidden relative">
          ...
          <div className="bg-linear-to-t from-background w-full h-1/2 z-5 absolute left-0 bottom-0 flex items-end justify-center pb-12">
